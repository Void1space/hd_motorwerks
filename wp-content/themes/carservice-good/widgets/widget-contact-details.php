...
class cs_contact_details_widget extends WP_Widget 
{
    ...
    function cs_contact_details_widget() 
	{
		$widget_options = array(
			'classname' => 'cs_contact_details_widget',
			'description' => 'Displays Contact Details Box'
	...
	{	
		...
		jQuery(document).ready(function($){
			$("#<?php echo esc_attr($this->get_field_id('add_new_button')); ?>").click(function(){
...
//register widget
add_action('widgets_init', create_function('', 'return register_widget("cs_contact_details_widget");'));
?>