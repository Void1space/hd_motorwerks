jQuery(document).ready(function($){
	...
	$("#import_dummy").click(function(event){
		...
		$.ajax({
				...
				type: 'post',
				//dataType: 'json',
				data: "import_templates_sidebars=" + importTemplatesSidebars + "&action=carservice_import_dummy",
				success: function(json){
					json = $.trim(json);
					...
					$.ajax({
							...
							type: 'post',
							//dataType: 'json',
							data: "import_templates_sidebars=" + importTemplatesSidebars + "&action=carservice_import_dummy2",
