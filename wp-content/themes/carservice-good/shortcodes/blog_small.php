<?php
//blog
function cs_theme_blog_small($atts, $content)
{
	...
	if($blog_query->have_posts())
	{
		...
		while ($blog_query->have_posts()) : $blog_query->the_post();
			$post = new Cs_Post("small", $featured_image_size, (int)$show_post_date, (int)$show_post_views, 0, 0, 0, 0, 0, $i);
...
//visual composer
function cs_theme_blog_small_vc_init()
{
	//get posts list
	...
	$post_formats_array[__("All", 'carservice')] = "-";
...
add_action("init", "cs_theme_blog_small_vc_init");
?>
