...
//cost calculator
cs_get_theme_file("/shortcodes/cost_calculator_slider_box.php");
cs_get_theme_file("/shortcodes/cost_calculator_dropdown_box.php");
cs_get_theme_file("/shortcodes/cost_calculator_input_box.php");
cs_get_theme_file("/shortcodes/cost_calculator_summary_box.php");
cs_get_theme_file("/shortcodes/cost_calculator_contact_box.php");
...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			'param_name' => 'el_id',
			'description' => sprintf( __( 'Enter row ID (Note: make sure it is unique and valid according to <a href="%s" target="_blank">w3c specification</a>).', 'carservice' ), 'http://www.w3schools.com/tags/att_global_id.asp' ),
		),
		array(
			'type' => 'textfield',
