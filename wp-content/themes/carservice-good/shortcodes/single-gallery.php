<?php
//author
function cs_theme_single_gallery($atts, $content)
{
...
//visual composer
function cs_theme_single_gallery_vc_init()
{
	$params = array(
		array(
			"type" => "dropdown",
...
add_action("init", "cs_theme_single_gallery_vc_init");
?>
