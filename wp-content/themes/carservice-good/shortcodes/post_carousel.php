...
function cs_theme_post_carousel_shortcode($atts)
{
	...
	foreach($posts_list as $post) 
	{
		...
		if((int)$read_more)
		{
			$output .= '<div class="vc_row wpb_row vc_row-fluid padding-top-54 padding-bottom-17"><a title="' . __('READ MORE', 'carservice') . '" href="' . get_permalink() . '" class="more">' . __('READ MORE', 'carservice') . '</a></div>';
		}
		$output .= '</li>';
		$i++;
	}
