<?php
//blog
function cs_theme_blog_2_columns($atts, $content)
{
...
//visual composer
function cs_theme_blog_2_columns_vc_init()
{
	//get posts list
	...
	vc_map( array(
		"name" => __("Blog 2 Columns", 'carservice'),
		"base" => "blog_2_columns",
		"class" => "",
		"controls" => "full",
...
add_action("init", "cs_theme_blog_2_columns_vc_init");
?>