...
<div class="theme-page padding-bottom-70">
	...
	else
	{
		...
		echo do_shortcode('<div class="vc_row wpb_row vc_row-fluid margin-top-70">[blog cs_pagination="1" items_per_page="' . esc_attr(get_option('posts_per_page')) . '" offset="0" featured_image_size="default" ids="-" category="-" author="-" order_by="date" order="DESC" show_post_title="1" show_post_excerpt="1" read_more="1" show_post_categories="1" show_post_author="1" show_post_date="1" show_post_views="1" show_post_comments="1" is_search_results="0" top_margin="none" cs_pagination="1" show_post_tags="0"]</div>');
	}
	paginate_links();
	?>
	</div>
