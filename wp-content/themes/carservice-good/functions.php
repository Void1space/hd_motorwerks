		...
		<tr>
			...
			<td>
				<select style="width: 120px;" id="ql_services_icon" name="ql_services_icon">
					...
					<option class="sl-small-air-conditioning" value="air-conditioning"' . ($icon=="air-conditioning" ? ' selected="selected"' : '') . '>' . __('air-conditioning', 'carservice') . '</option>
					<option class="sl-small-alarm" value="alarm"' . ($icon=="alarm" ? ' selected="selected"' : '') . '>' . __('alarm', 'carservice') . '</option>
					<option class="sl-small-camper" value="camper"' . ($icon=="camper" ? ' selected="selected"' : '') . '>' . __('camper', 'carservice') . '</option>
					<option class="sl-small-car" value="car"' . ($icon=="car" ? ' selected="selected"' : '') . '>' . __('car', 'carservice') . '</option>
					<option class="sl-small-car-2" value="car-2"' . ($icon=="car-2" ? ' selected="selected"' : '') . '>' . __('car-2', 'carservice') . '</option>
					<option class="sl-small-car-3" value="car-3"' . ($icon=="car-3" ? ' selected="selected"' : '') . '>' . __('car-3', 'carservice') . '</option>
					<option class="sl-small-car-audio" value="car-audio"' . ($icon=="car-audio" ? ' selected="selected"' : '') . '>' . __('car-audio', 'carservice') . '</option>
					<option class="sl-small-car-battery" value="car-battery"' . ($icon=="car-battery" ? ' selected="selected"' : '') . '>' . __('car-battery', 'carservice') . '</option>
					<option class="sl-small-car-check" value="car-check"' . ($icon=="car-check" ? ' selected="selected"' : '') . '>' . __('car-check', 'carservice') . '</option>
					<option class="sl-small-car-checklist" value="car-checklist"' . ($icon=="car-checklist" ? ' selected="selected"' : '') . '>' . __('car-checklist', 'carservice') . '</option>
					<option class="sl-small-car-fire" value="car-fire"' . ($icon=="car-fire" ? ' selected="selected"' : '') . '>' . __('car-fire', 'carservice') . '</option>
					<option class="sl-small-car-fix" value="car-fix"' . ($icon=="car-fix" ? ' selected="selected"' : '') . '>' . __('car-fix', 'carservice') . '</option>
					<option class="sl-small-car-key" value="car-key"' . ($icon=="car-key" ? ' selected="selected"' : '') . '>' . __('car-key', 'carservice') . '</option>
					<option class="sl-small-car-lock" value="car-lock"' . ($icon=="car-lock" ? ' selected="selected"' : '') . '>' . __('car-lock', 'carservice') . '</option>
					<option class="sl-small-car-music" value="car-music"' . ($icon=="car-music" ? ' selected="selected"' : '') . '>' . __('car-music', 'carservice') . '</option>
					<option class="sl-small-car-oil" value="car-oil"' . ($icon=="car-oil" ? ' selected="selected"' : '') . '>' . __('car-oil', 'carservice') . '</option>
					<option class="sl-small-car-setting" value="car-setting"' . ($icon=="car-setting" ? ' selected="selected"' : '') . '>' . __('car-setting', 'carservice') . '</option>
					<option class="sl-small-car-wash" value="car-wash"' . ($icon=="car-wash" ? ' selected="selected"' : '') . '>' . __('car-wash', 'carservice') . '</option>
					<option class="sl-small-car-wheel" value="car-wheel"' . ($icon=="car-wheel" ? ' selected="selected"' : '') . '>' . __('car-wheel', 'carservice') . '</option>
					<option class="sl-small-caution-fence" value="caution-fence"' . ($icon=="caution-fence" ? ' selected="selected"' : '') . '>' . __('caution-fence', 'carservice') . '</option>
					<option class="sl-small-certificate" value="certificate"' . ($icon=="certificate" ? ' selected="selected"' : '') . '>' . __('certificate', 'carservice') . '</option>
					<option class="sl-small-check" value="check"' . ($icon=="check" ? ' selected="selected"' : '') . '>' . __('check', 'carservice') . '</option>
					<option class="sl-small-check-2" value="check-2"' . ($icon=="check-2" ? ' selected="selected"' : '') . '>' . __('check-2', 'carservice') . '</option>
					<option class="sl-small-check-shield" value="check-shield"' . ($icon=="check-shield" ? ' selected="selected"' : '') . '>' . __('check-shield', 'carservice') . '</option>
					<option class="sl-small-checklist" value="checklist"' . ($icon=="checklist" ? ' selected="selected"' : '') . '>' . __('checklist', 'carservice') . '</option>
					<option class="sl-small-clock" value="clock"' . ($icon=="clock" ? ' selected="selected"' : '') . '>' . __('clock', 'carservice') . '</option>
					<option class="sl-small-coffee" value="coffee"' . ($icon=="coffee" ? ' selected="selected"' : '') . '>' . __('coffee', 'carservice') . '</option>
					<option class="sl-small-cog-double" value="cog-double"' . ($icon=="cog-double" ? ' selected="selected"' : '') . '>' . __('cog-double', 'carservice') . '</option>
					<option class="sl-small-eco-car" value="eco-car"' . ($icon=="eco-car" ? ' selected="selected"' : '') . '>' . __('eco-car', 'carservice') . '</option>
					<option class="sl-small-eco-fuel" value="eco-fuel"' . ($icon=="eco-fuel" ? ' selected="selected"' : '') . '>' . __('eco-fuel', 'carservice') . '</option>
					<option class="sl-small-eco-fuel-barrel" value="eco-fuel-barrel"' . ($icon=="eco-fuel-barrel" ? ' selected="selected"' : '') . '>' . __('eco-fuel-barrel', 'carservice') . '</option>
					<option class="sl-small-eco-globe" value="eco-globe"' . ($icon=="eco-globe" ? ' selected="selected"' : '') . '>' . __('eco-globe', 'carservice') . '</option>
					<option class="sl-small-eco-nature" value="eco-nature"' . ($icon=="eco-nature" ? ' selected="selected"' : '') . '>' . __('eco-nature', 'carservice') . '</option>
					<option class="sl-small-electric-wrench" value="electric-wrench"' . ($icon=="electric-wrench" ? ' selected="selected"' : '') . '>' . __('electric-wrench', 'carservice') . '</option>
					<option class="sl-small-email" value="email"' . ($icon=="email" ? ' selected="selected"' : '') . '>' . __('email', 'carservice') . '</option>
					<option class="sl-small-engine-belt" value="engine-belt"' . ($icon=="engine-belt" ? ' selected="selected"' : '') . '>' . __('engine-belt', 'carservice') . '</option>
					<option class="sl-small-engine-belt-2" value="engine-belt-2"' . ($icon=="engine-belt-2" ? ' selected="selected"' : '') . '>' . __('engine-belt-2', 'carservice') . '</option>
					<option class="sl-small-facebook" value="facebook"' . ($icon=="facebook" ? ' selected="selected"' : '') . '>' . __('facebook', 'carservice') . '</option>
					<option class="sl-small-faq" value="faq"' . ($icon=="faq" ? ' selected="selected"' : '') . '>' . __('faq', 'carservice') . '</option>
					<option class="sl-small-fax" value="fax"' . ($icon=="fax" ? ' selected="selected"' : '') . '>' . __('fax', 'carservice') . '</option>
					<option class="sl-small-fax-2" value="fax-2"' . ($icon=="fax-2" ? ' selected="selected"' : '') . '>' . __('fax-2', 'carservice') . '</option>
					<option class="sl-small-garage" value="garage"' . ($icon=="garage" ? ' selected="selected"' : '') . '>' . __('garage', 'carservice') . '</option>
					<option class="sl-small-gauge" value="gauge"' . ($icon=="gauge" ? ' selected="selected"' : '') . '>' . __('gauge', 'carservice') . '</option>
					<option class="sl-small-gearbox" value="gearbox"' . ($icon=="gearbox" ? ' selected="selected"' : '') . '>' . __('gearbox', 'carservice') . '</option>
					<option class="sl-small-google-plus" value="google-plus"' . ($icon=="google-plus" ? ' selected="selected"' : '') . '>' . __('google-plus', 'carservice') . '</option>
					<option class="sl-small-gps" value="gps"' . ($icon=="gps" ? ' selected="selected"' : '') . '>' . __('gps', 'carservice') . '</option>
					<option class="sl-small-headlight" value="headlight"' . ($icon=="headlight" ? ' selected="selected"' : '') . '>' . __('headlight', 'carservice') . '</option>
					<option class="sl-small-heating" value="heating"' . ($icon=="heating" ? ' selected="selected"' : '') . '>' . __('heating', 'carservice') . '</option>
					<option class="sl-small-image" value="image"' . ($icon=="image" ? ' selected="selected"' : '') . '>' . __('image', 'carservice') . '</option>
					<option class="sl-small-images" value="images"' . ($icon=="images" ? ' selected="selected"' : '') . '>' . __('images', 'carservice') . '</option>
					<option class="sl-small-inflator-pump" value="inflator-pump"' . ($icon=="inflator-pump" ? ' selected="selected"' : '') . '>' . __('inflator-pump', 'carservice') . '</option>
					<option class="sl-small-lightbulb" value="lightbulb"' . ($icon=="lightbulb" ? ' selected="selected"' : '') . '>' . __('lightbulb', 'carservice') . '</option>
					<option class="sl-small-location-map" value="location-map"' . ($icon=="location-map" ? ' selected="selected"' : '') . '>' . __('location-map', 'carservice') . '</option>
					<option class="sl-small-oil-can" value="oil-can"' . ($icon=="oil-can" ? ' selected="selected"' : '') . '>' . __('oil-can', 'carservice') . '</option>
					<option class="sl-small-oil-gauge" value="oil-gauge"' . ($icon=="oil-gauge" ? ' selected="selected"' : '') . '>' . __('oil-gauge', 'carservice') . '</option>
					<option class="sl-small-oil-station" value="oil-station"' . ($icon=="oil-station" ? ' selected="selected"' : '') . '>' . __('oil-station', 'carservice') . '</option>
					<option class="sl-small-parking-sensor" value="parking-sensor"' . ($icon=="parking-sensor" ? ' selected="selected"' : '') . '>' . __('parking-sensor', 'carservice') . '</option>
					<option class="sl-small-payment" value="payment"' . ($icon=="payment" ? ' selected="selected"' : '') . '>' . __('payment', 'carservice') . '</option>
					<option class="sl-small-pen" value="pen"' . ($icon=="pen" ? ' selected="selected"' : '') . '>' . __('pen', 'carservice') . '</option>
					<option class="sl-small-percent" value="percent"' . ($icon=="percent" ? ' selected="selected"' : '') . '>' . __('percent', 'carservice') . '</option>
					<option class="sl-small-person" value="person"' . ($icon=="person" ? ' selected="selected"' : '') . '>' . __('person', 'carservice') . '</option>
					<option class="sl-small-phone" value="phone"' . ($icon=="phone" ? ' selected="selected"' : '') . '>' . __('phone', 'carservice') . '</option>
					<option class="sl-small-phone-call" value="phone-call"' . ($icon=="phone-call" ? ' selected="selected"' : '') . '>' . __('phone-call', 'carservice') . '</option>
					<option class="sl-small-phone-call-24h" value="phone-call-24h"' . ($icon=="phone-call-24h" ? ' selected="selected"' : '') . '>' . __('phone-call-24h', 'carservice') . '</option>
					<option class="sl-small-phone-circle" value="phone-circle"' . ($icon=="phone-circle" ? ' selected="selected"' : '') . '>' . __('phone-circle', 'carservice') . '</option>
					<option class="sl-small-piggy-bank" value="piggy-bank"' . ($icon=="piggy-bank" ? ' selected="selected"' : '') . '>' . __('piggy-bank', 'carservice') . '</option>
					<option class="sl-small-quote" value="quote"' . ($icon=="quote" ? ' selected="selected"' : '') . '>' . __('quote', 'carservice') . '</option>
					<option class="sl-small-road" value="road"' . ($icon=="road" ? ' selected="selected"' : '') . '>' . __('road', 'carservice') . '</option>
					<option class="sl-small-screwdriver" value="screwdriver"' . ($icon=="screwdriver" ? ' selected="selected"' : '') . '>' . __('screwdriver', 'carservice') . '</option>
					<option class="sl-small-seatbelt-lock" value="seatbelt-lock"' . ($icon=="seatbelt-lock" ? ' selected="selected"' : '') . '>' . __('seatbelt-lock', 'carservice') . '</option>
					<option class="sl-small-service-24h" value="service-24h"' . ($icon=="service-24h" ? ' selected="selected"' : '') . '>' . __('service-24h', 'carservice') . '</option>
					<option class="sl-small-share-time" value="share-time"' . ($icon=="share-time" ? ' selected="selected"' : '') . '>' . __('share-time', 'carservice') . '</option>
					<option class="sl-small-shopping-cart" value="shopping-cart"' . ($icon=="shopping-cart" ? ' selected="selected"' : '') . '>' . __('shopping-cart', 'carservice') . '</option>
					<option class="sl-small-signal-warning" value="signal-warning"' . ($icon=="signal-warning" ? ' selected="selected"' : '') . '>' . __('signal-warning', 'carservice') . '</option>
					<option class="sl-small-sign-zigzag" value="sign-zigzag"' . ($icon=="sign-zigzag" ? ' selected="selected"' : '') . '>' . __('sign-zigzag', 'carservice') . '</option>
					<option class="sl-small-snow-crystal" value="snow-crystal"' . ($icon=="snow-crystal" ? ' selected="selected"' : '') . '>' . __('snow-crystal', 'carservice') . '</option>
					<option class="sl-small-speed-gauge" value="speed-gauge"' . ($icon=="speed-gauge" ? ' selected="selected"' : '') . '>' . __('speed-gauge', 'carservice') . '</option>
					<option class="sl-small-steering-wheel" value="steering-wheel"' . ($icon=="steering-wheel" ? ' selected="selected"' : '') . '>' . __('steering-wheel', 'carservice') . '</option>
					<option class="sl-small-testimonials" value="testimonials"' . ($icon=="testimonials" ? ' selected="selected"' : '') . '>' . __('testimonials', 'carservice') . '</option>
					<option class="sl-small-toolbox" value="toolbox"' . ($icon=="toolbox" ? ' selected="selected"' : '') . '>' . __('toolbox', 'carservice') . '</option>
					<option class="sl-small-toolbox-2" value="toolbox-2"' . ($icon=="toolbox-2" ? ' selected="selected"' : '') . '>' . __('toolbox-2', 'carservice') . '</option>
					<option class="sl-small-truck" value="truck"' . ($icon=="truck" ? ' selected="selected"' : '') . '>' . __('truck', 'carservice') . '</option>
					<option class="sl-small-truck-tow" value="truck-tow"' . ($icon=="truck-tow" ? ' selected="selected"' : '') . '>' . __('truck-tow', 'carservice') . '</option>
					<option class="sl-small-tunning" value="tunning"' . ($icon=="tunning" ? ' selected="selected"' : '') . '>' . __('tunning', 'carservice') . '</option>
					<option class="sl-small-twitter" value="twitter"' . ($icon=="twitter" ? ' selected="selected"' : '') . '>' . __('twitter', 'carservice') . '</option>
					<option class="sl-small-user-chat" value="user-chat"' . ($icon=="user-chat" ? ' selected="selected"' : '') . '>' . __('user-chat', 'carservice') . '</option>
					<option class="sl-small-video" value="video"' . ($icon=="video" ? ' selected="selected"' : '') . '>' . __('video', 'carservice') . '</option>
					<option class="sl-small-wallet" value="wallet"' . ($icon=="wallet" ? ' selected="selected"' : '') . '>' . __('wallet', 'carservice') . '</option>
					<option class="sl-small-wedding-car" value="wedding-car"' . ($icon=="wedding-car" ? ' selected="selected"' : '') . '>' . __('wedding-car', 'carservice') . '</option>
					<option class="sl-small-windshield" value="windshield"' . ($icon=="windshield" ? ' selected="selected"' : '') . '>' . __('windshield', 'carservice') . '</option>
					<option class="sl-small-wrench" value="wrench"' . ($icon=="wrench" ? ' selected="selected"' : '') . '>' . __('wrench', 'carservice') . '</option>
					<option class="sl-small-wrench-double" value="wrench-double"' . ($icon=="wrench-double" ? ' selected="selected"' : '') . '>' . __('wrench-double', 'carservice') . '</option>
					<option class="sl-small-wrench-screwdriver" value="wrench-screwdriver"' . ($icon=="wrench-screwdriver" ? ' selected="selected"' : '') . '>' . __('wrench-screwdriver', 'carservice') . '</option>
					<option class="sl-small-youtube" value="youtube"' . ($icon=="youtube" ? ' selected="selected"' : '') . '>' . __('youtube', 'carservice') . '</option>
				</select>
			</td>
		</tr>
	</table>';
