...
function cs_theme_after_setup_theme()
{
	...
	{		
		$theme_options = array(
			...
			"footer_text" => sprintf(__('© Copyright 2020 <a target="_blank" title="%s" href="%s" rel="nofollow">Car Service Theme</a> by <a target="_blank" title="%s" href="%s">QuanticaLabs</a>', 'carservice'), esc_html__('Car Service Theme', 'carservice'), esc_url(__('https://1.envato.market/car-service-mechanic-auto-shop-wordpress-theme', 'carservice')), esc_html__('QuanticaLabs', 'carservice'), esc_url(__('http://quanticalabs.com', 'carservice'))),
			"sticky_menu" => 0,
			"responsive" => 1,
			"scroll_top" => 1,
			"layout" => 'fullwidth',
