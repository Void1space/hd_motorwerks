		...
		<div class="header">
			...
			<div class="header_right">
				<div class="description">
					<h3>
						<a href="<?php echo esc_url(__('https://1.envato.market/car-service-mechanic-auto-shop-wordpress-theme', 'carservice')); ?>" title="<?php esc_attr_e("Car Service - Mechanic Auto Shop WordPress Theme", 'carservice'); ?>" rel="nofollow">
							<?php _e("Car Service - Mechanic Auto Shop Theme", 'carservice'); ?>
						</a>
					</h3>
					<h5><?php _e("Version 5.9", 'carservice'); ?></h5>
		...
		<div class="footer">
			<div class="footer_left">
				<ul class="social-list">
					...
					<li><a target="_blank" href="<?php echo esc_url(__('https://1.envato.market/quanticalabs', 'carservice')); ?>" class="social-envato" title="<?php esc_html_e('Envato', 'carservice'); ?>"></a></li>
					...
					<li><a target="_blank" href="<?php echo esc_url(__('https://dribbble.com/QuanticaLabs', 'carservice')); ?>" class="social-dribbble" title="<?php esc_html_e('Dribbble', 'carservice'); ?>"></a></li>
				</ul>
			</div>
