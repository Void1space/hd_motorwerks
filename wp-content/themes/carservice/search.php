...
<div class="theme-page padding-bottom-66">
	<div class="vc_row wpb_row vc_row-fluid gray full-width page-header vertical-align-table">
		<div class="vc_row wpb_row vc_inner vc_row-fluid">
			<div class="page-header-left">
				<h1 class="page-title"><?php _e("SEARCH RESULTS FOR:", 'carservice'); echo " " . esc_attr(get_query_var('s'));?></h1>
			</div>
			<div class="page-header-right">
				<div class="bread-crumb-container">
					...
					<ul class="bread-crumb">
						...
						<li>
							<?php _e("SEARCH RESULTS", 'carservice'); ?>
						</li>
					</ul>
				</div>
			</div>
	...
	<div class="clearfix">
		...
		else
		{
			...
			echo '<div class="vc_row wpb_row vc_row-fluid margin-top-70"><div class="vc_col-sm-12 wpb_column vc_column_container">' . cs_theme_blog(array("is_search_results" => "1")) . '</div></div>';
		}
		?>
	</div>
</div>
