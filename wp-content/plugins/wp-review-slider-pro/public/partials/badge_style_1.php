...
if($ctext=='' && $ctext2==''){
	...
	$div12html = '<span class="wppro_badge1_DIV_12 b4s12"><span class="wppro_badge1_SPAN_13">'.$ctext_url_start.$finalavg.'</span>&nbsp;'.$ctext.$ctext_url_end.'</span>';
} else if($ctext!='' && $ctext2!=''){
	$div12html = '<span class="wppro_badge1_DIV_12 b4s12"><span class="wppro_badge1_SPAN_13">'.$finalavg.'</span>&nbsp;'.$ctext.'&nbsp;'.$ctext_url_start.'<span class="wppro_badge1_SPAN_15">'.$finaltotalhtml.'</span>'.$ctext2.$ctext_url_end.'</span>';
}
...
<div class="wprevpro_badge wppro_badge1_DIV_1" id="wprev-badge-<?php echo $currentform[0]->id; ?>">
	...
	<?php echo $logohtml; ?><span class="wppro_badge1_SPAN_4"><?php echo $businessname; ?></span>
