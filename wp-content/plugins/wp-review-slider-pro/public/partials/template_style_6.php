...
foreach ( $rowarray[$x] as $review ) 
{
	...
	if($currentform[0]->display_num>0){
		...
		if($userpic==""){
			...
			$userpichtml = $profilelink['start'].'<img src="'.$userpic.'" alt="'.$tempreviewername.' Avatar" class="wpproslider_t6_IMG_2 wprevpro_avatarimg" />'.$profilelink['end'];
			if(isset($template_misc_array['avataropt'])){
				if($template_misc_array['avataropt']=='hide'){
					...
					$userpichtml = $profilelink['start'].'<img src="'.$tempuserpic.'" alt="'.$tempreviewername.' Avatar" class="wpproslider_t6_IMG_2 wprevpro_avatarimg" />'.$profilelink['end'];
				}
			}
		}
		...
		if(isset($template_misc_array['showtitle'])){
			if(isset($review->review_title)){
				if($template_misc_array['showtitle']=="hide"){
					...
					$title = '<span class="wprevpro_t6_DIV_title">'.stripslashes(strip_tags($review->review_title)).' </span>';
				}
			}
		}
...
<div class="wpproslider_t6_DIV_1a">
	<div class="wpproslider_t6_DIV_2 wprev_preview_bg1_T<?php echo $currentform[0]->style; ?><?php if($iswidget){echo "_widget";} ?> wprev_preview_bradius_T<?php echo $currentform[0]->style; ?><?php if($iswidget){echo "_widget";} ?>">
	<div class="wpproslider_t6_DIV_2_top">
		...
		<div class="wpproslider_t6_DIV_3">
			...
			<div class="wpproslider_t6_star_DIV"><span class="wprevpro_star_imgs_T<?php echo $currentform[0]->style; ?><?php if($iswidget){echo "_widget";} ?>"><?php echo $starhtml; ?></span></div>
	...
	<div class="indrevdiv wpproslider_t6_DIV_4">
			<p class="wpproslider_t6_P_4 wprev_preview_tcolor1_T<?php echo $currentform[0]->style; ?><?php if($iswidget){echo "_widget";} ?>">
