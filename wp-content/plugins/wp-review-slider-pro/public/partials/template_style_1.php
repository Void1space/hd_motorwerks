	...
	foreach ( $rowarray[$x] as $review ) 
	{
		...
		if($userpic==""){
			...
			if($template_misc_array['default_avatar']=='fb'){
				...
				//$userpic = 'https://ui-avatars.com/api/?name='.str_replace(' ', '+', $tempreviewername).'&background=0173AA&color=fff&size=60';
		...
		if($userpic==""){
			...
			if(isset($template_misc_array['avataropt'])){
				if($template_misc_array['avataropt']=='hide'){
					...
					//$tempuserpic = 'https://ui-avatars.com/api/?name='.str_replace(' ', '+', $tempreviewername).'&background=0173AA&color=fff&size=60';
