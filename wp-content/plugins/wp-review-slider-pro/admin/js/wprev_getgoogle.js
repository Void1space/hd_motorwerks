...
(function( $ ) {
	 ...
	 */
	 ...
	 $(function(){
		...
		jQuery( "#wpfbr_google_location_set_place_id" ).change(function() {
		...
		//look-up btn clicks
		jQuery('#wpfbr_btn_lookup_google_location_set').click(function(event){
			currentloc = 1;
			//show look up form
		...
		jQuery('.locationlookupbtn').click(function(event){
		...
		$( "#google_api_key" ).change(function() {
		  setapikeyonchange();
		});
