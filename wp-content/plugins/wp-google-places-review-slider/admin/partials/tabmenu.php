...
?>	
	...
	<a href="https://ljapps.com/wp-review-slider-pro/" target="_blank" class="nav-tab <?php if($_GET['page']=='wp_google-get_pro'){echo 'nav-tab-active';} ?>"><?php _e('Get Pro Version', 'wp-google-reviews'); ?></a>
	</h2>