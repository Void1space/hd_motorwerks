...
* Works even if Yelp is unavailable
...
1. Yelp Reviews widget
3. Yelp Reviews sidebar

== Changelog ==

= 1.7.5 =
* Update plugin to WordPress 5.6

= 1.7.4 =
* Security pass fixes

= 1.7.3 =
* Update plugin to WordPress 5.5

= 1.7.2 =
* Bugfix: W3C compatibility

= 1.7.1 =
* Improve: auto-updating reviews option
...
* Bugfix: fixed problem with tabs on the setting page

= 1.6.1 =
* Improve: instruction for getting Yelp API key was updated
* Improve: added error message for incorrect Yelp API key
...
* Improve: added a service option for re-creating of database
...
= 1.1 =
* Added common libs for urlopen and debug
